...
<body class="main-body app sidebar-mini ltr">
    ...
    <div class="page custom-index">
		...
		<div class="main-footer ht-45">
			...
			<span> Copyright © 2022 <a href="javascript:void(0);" class="text-primary">Azira</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0);"> KARIN </a> All rights reserved.</span>
			</div>
		</div>
		<!-- Footer closed -->
    </div>
