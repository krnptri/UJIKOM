...
Route::group(['middleware'=>['auth','roleaccess:administrator']], function(){
    Route::resource('/data_pengguna','DataPenggunaController')->except(['show'])->middleware(['auth','roleaccess:administrator,operator']);
    Route::match(['get','post'],'/data_pengguna', [DataPenggunaController::class, 'index'])->name('data_pengguna')->middleware(['auth','roleaccess:administrator,operator']);
    Route::get('/data_pengguna/input', [DataPenggunaController::class, 'input'])->name('data_pengguna.input')->middleware(['auth','roleaccess:administrator,operator']);
    Route::post('/data_pengguna/create', [DataPenggunaController::class, 'create'])->name('data_pengguna.create')->middleware(['auth','roleaccess:administrator,operator']);
    Route::get('/data_pengguna/edit/{id}', [DataPenggunaController::class, 'edit'])->name('data_pengguna.edit')->middleware(['auth','roleaccess:administrator,operator']);
    Route::put('/data_pengguna/update/{id}', [DataPenggunaController::class, 'update'])->name('data_pengguna.update')->middleware(['auth','roleaccess:administrator,operator']);
    Route::delete('/data_pengguna/destroy/{id}', [DataPenggunaController::class, 'destroy'])->name('data_pengguna.destroy')->middleware(['auth','roleaccess:administrator,operator']);
